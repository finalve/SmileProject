	...
	return (<>
		<div className="main-panel">
			<div className="content-wrapper">
				...
				{data.openorder.map((element, index) =>
				(
					<div className="row">
							...
							<div className="card">
								<div className="card-body">
									<div className='d-flex justify-content-center bg-secondary bg-opacity-50 border-bottom'>
										...
										<div className='p-2 w-25  text-light text-center'>Wait</div>
									...
									<div className='d-flex justify-content-center bg-opacity-50 border-bottom' key={index} >
										...
										<div className='d-flex justify-content-center  bg-opacity-50' >
											<div className='p-2 w-25  text-light text-start'>{element.data[1].symbol}</div>
											<div className='p-2 w-25  text-light text-end'>{element.data[1].price}</div>
										</div>
										<div className='d-flex justify-content-center  bg-opacity-50' >
											<div className='p-2 w-25  text-light text-start'>{element.data[2].symbol}</div>
											<div className='p-2 w-25  text-light text-end'>{element.data[2].price}</div>
										</div>
										<div className='d-flex justify-content-center  bg-opacity-50 border-bottom ' >
											<div className='p-2 w-25  text-light text-start'>{element.data[3].symbol}</div>
											<div className='p-2 w-25  text-light text-end'>{element.data[3].price}</div>
										</div>
