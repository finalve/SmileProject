	...
	return (<>
		<div className='row mt-5 d-flex justify-content-center'>
			...
			<div className='input-group input-group-sm mb-3'>
				...
				<input className='form-control form-control-sm' type='text' name='username' value={data.label} onChange={setInput} />
			</div>
			...
			<div className='input-group input-group-sm mb-3'>
				<div className="input-group-prepend w-25">
					<span className="input-group-text w-100">Conf-PWD</span>
				</div>
				<input className='form-control form-control-sm' type='password' name='password' value={data.password} onChange={setInput} />
			</div>
