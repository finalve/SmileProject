...
class Arbitrage {
	...
	async #calcurate({ base, stable, target, filter }) {
		...
		const { quantity, target_quantity, invest, profit, result } = this.#calculateProfit(20.0 / stable.a, stable.a, target.b, base.b, filter.lotsize)
		const{ r_quantity, r_target_quantity, r_invest, r_profit, r_result } = this.#calculateReverseProfit(20.0 / base.a, base.a, target.a, stable.b, filter.lotsize)
